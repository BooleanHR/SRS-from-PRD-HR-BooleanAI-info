...
## :dart: Summary
- **기능명:** [FR-054] Layer 1: Input vs OCR comparison
- **Epic:** Triple Check
- **목적:** Compares applicant input values against OCR extracted values field-by-field (name, issueNumber, issueDate, issuerName). Returns match/mismatch per field.
