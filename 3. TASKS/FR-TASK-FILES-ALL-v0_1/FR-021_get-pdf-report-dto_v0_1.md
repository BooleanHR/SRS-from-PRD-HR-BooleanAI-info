...
- SRS 문서: [`SRS-HR-AI-Verification-v1.1.md#§3.7 API Overview (GET /api/reports/[batch_id]/pdf)`](../SRS-HR-AI-Verification-v1.1.md)
...
---
*Document Version: v0.1 (초안) | Source: TASK-LIST C-005 | SRS: v1.1*
