...
## :dart: Summary
- **기능명:** [FR-069] Verification detail modal/page UI
- **Epic:** HITL Approval
- **목적:** OCR vs Agency comparison layout + mismatch highlight UI + API snapshot panel. src/components/dashboard/detail-comparison.tsx.
